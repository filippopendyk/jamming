...
export class App extends React.Component{
  constructor(props){
    super(props);
    this.state = {
      searchResults: [{name: 'Example1', artist: 'Artist1', album: 'Album1', id: 0, uri: 'www.spotify.com/uri3'}, {name: 'Example2', artist: 'Artist2', album: 'Album2', id: 1, uri: 'www.spotify.com/uri4'}],
